...
class cls_gen_biz_stat_client_reg_type extends clsBase
{
	public $m_pk_stat_cust_reg_type_id=0;
	...
	{
		try{
			$sql = "CALL spm_iu_mst_biz_stat_cust_reg_type(".$this->m_pk_stat_cust_reg_type_id.",'".$this->m_uk_registration_code."','".$this->m_registration_type."','".$this->m_data_type."',".$this->m_max_length.",".$this->mCreatedBy.",".$this->mCreatedBy.",".$this->mUpdatedby.")";
