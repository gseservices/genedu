...
class cls_document_category extends clsBase
{
	public $m_pk_doc_category_id=0;
	public $m_uk_doc_category_code="Code6";
	public $m_doc_category_name="Name";
	...
	public function Add()
	{
		try{
			$this->mUpdatedby=1;
			$this->mCreatedBy=1;
			$sql = "CALL spm_iu_mst_biz_document_category(".$this->m_pk_doc_category_id.",'".$this->m_uk_doc_category_code."','".$this->m_doc_category_name."','".$this->m_description."',".$this->mCreatedBy.",".$this->mUpdatedby.",'".$this->m_p_xml."')";			
	...
	{
		try{
			$sql = "CALL spm_iu_mst_biz_document_category(".$this->m_pk_doc_category_id.",'".$this->m_uk_doc_category_code."','".$this->m_doc_category_name."','".$this->m_description."',".$this->mCreatedBy.",".$this->mCreatedBy.",".$this->mUpdatedby.")";
	...
	public function Delete()
	{
		try{
			...
			$sql = "CALL spm_sfd_mst_biz_document_category(".$this->m_pk_doc_category_id.",".$this->m_deleted_by.",'".$this->m_deletedtype."')";			
			$result = $this->dbal->execScalar($sql,false);
			return $result;
		}catch (Exception $ex)
		{
